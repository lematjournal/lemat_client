...
angular.module('lematClient').controller('UserController', ['$scope', '$rootScope', '$modal', '$location', '$route', '$routeParams', 'AuthFactory', 'UserFactory', 'ProfileFactory', function ($scope, $rootScope, $modal, $location, $route, $routeParams, AuthFactory, UserFactory, ProfileFactory) {
   ...
   $scope.open = function () {
      $scope.$modalInstance = $modal.open({
         scope: $scope,
         templateUrl: 'views/admin/modals/image-upload.html',
